...
export default class LandingBG extends Component {
  ...
  constructor(props) {
    ...
    componentDidMount() {
        ...
        gsapScript.src = "https://cdnjs.cloudflare.com/ajax/libs/gsap/3.3.4/gsap.min.js";
        ...
        stScript.src = "https://cdnjs.cloudflare.com/ajax/libs/gsap/3.3.4/ScrollTrigger.min.js";
        stScript.async = true;
        stScript.onload = () => this.scriptLoaded("scrollTrigger");
    ...
    scriptLoaded(scriptName){ 
      ...
      if(scriptName === "gsap") this.gsap = true;
      if(scriptName === "scrollTrigger") this.scrollTrigger = true;
